      ...
      <div className={styles.main}>
        ...
        <section className={styles.right}>
          ...
          <p className={styles.tip}>
            ...
            экраном. В шлеме справа панель «Видео»: пауза, громкость и перемотка лучом контроллера.
            Если звука нет сразу, включи его на этой панели. Слева от экрана в VR — кнопка «Выйти на
            сайт».
          </p>
